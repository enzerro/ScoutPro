        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              <Link to="/players" className="text-sm text-muted-foreground transition-colors hover:text-primary">
                {t.nav.players}
              </Link>
              <Link to="/compare" className="text-sm text-muted-foreground transition-colors hover:text-primary">
                {t.nav.compare}
              </Link>
            </nav>
          </div>
