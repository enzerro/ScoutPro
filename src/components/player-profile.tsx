    ...
    return (
      <div className="flex min-h-[50vh] items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/players" className="mt-4 inline-block text-sm text-primary hover:underline">
            {t.profile.back}
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
      ...
      <div className="mb-8 flex flex-col gap-6 rounded-2xl border border-border bg-card p-6 md:flex-row md:items-start md:p-8">
        <div className="h-32 w-32 flex-shrink-0 overflow-hidden rounded-2xl bg-secondary">
          {player.image ? (
            <img 
              src={player.image} 
              alt={player.name}
